      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildBulletPoint('PC is connected to the same WiFi/hotspot network'),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (e.toString().contains('timeout')) {
          errorMessage = 'Connection timeout. Please check if the IP and port are correct.';
        } else if (e.toString().contains('refused')) {
          errorMessage = 'Connection refused. Please make sure the server is running.';
        } else if (e.toString().contains('network is unreachable')) {
          errorMessage = 'Network unreachable. Please check your network connection.';
        }
